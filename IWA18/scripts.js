...
const handleHelpToggleClose = (event) => {
    const closeHelp = html.help.overlay
    closeHelp.style.display = 'none'
}
const handleHelpToggleOpen = (event) => {
    const openHelp = html.help.overlay
    openHelp.style.display = 'block'
}
const handleAddToggleOpen = (event) => {
    const openOrder = html.add.overlay
    openOrder.style.display = 'block'
}
const handleAddToggleClose = (event) => {
    const closeOrder = html.add.overlay
...
const handleEditToggleOpen = (event) => {
    ...
    const eventId = event.target.dataset.id
    const openEdit = html.edit.overlay
    openEdit.style.display = 'block'
}
const handleEditToggleClosed = (event) => {
    const closeEdit = html.edit.overlay
